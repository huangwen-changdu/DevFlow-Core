...
- Design: requirement, feature request, behavior change, architecture change, ambiguity, multi-solution decision, or unclear small-feature boundary. Run Sense -> Brainstorm -> [STOP: Depth A/B/C] -> (A: devflow-spec -> /devflow-plan | B: /devflow-plan | C: direct) -> Cut; continue to Build/Prove when implementation is requested.
