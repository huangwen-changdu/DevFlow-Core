...
const scenarios = [
  ...
  },
  {
    ...
    evidence: [
      ["skills/devflow-plan/SKILL.md", "## Progress"],
      ["skills/devflow-plan/SKILL.md", "Rejected"],
      ["skills/devflow-plan/SKILL.md", "Six fields per task"],
      ["skills/devflow-plan/SKILL.md", "one delivery unit"],
      ["skills/devflow-plan/SKILL.md", "fresh reviewer's gate"],
      ["skills/devflow-plan/SKILL.md", "broadly rediscover the repository"],
      ["skills/devflow-build/SKILL.md", "one directly changed neighbor"],
      ["scripts/devflow-plan.js", "maximumWorklistItems"],
      ["scripts/devflow-plan.js", "--index"],
      ["scripts/devflow-plan.js", "multiResult"],
