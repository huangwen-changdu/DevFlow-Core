...
const cases = [
  ...
  },
  {
    ...
    checks: [
      ...
      ["devflow-pua", files.pua, "🟠 {味道} 方法论：{方法}"],
      ["devflow-pua", files.pua, "切换："],
      ...
      ["devflow-pua display", files.puaDisplay, "🟠 {味道} 方法论：{方法}"],
      ...
      ["devflow-brainstorm", files.brainstorm, "🟠 {味道} 方法论：{方法}"],
...
const commandCases = [
  ...
  },
  {
    ...
    checks: [
      ...
      ["devflow-pua command", files.puaCommand, "🟠 {味道} 方法论：{方法}"],
      ["devflow-pua command", files.puaCommand, "切换："],
