...
| [DSH Plugin Preset Distribution](cards/dsh-plugin-preset-distribution.md) | DSH 插件分发 agent preset, dsh plugin add, bundle patch, preset 同步, 插件打包 skills, 模拟插件 apply, 测试同步函数 | project | 0.5 |
